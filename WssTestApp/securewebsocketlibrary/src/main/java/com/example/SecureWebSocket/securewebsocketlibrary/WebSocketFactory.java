...
public class WebSocketFactory
{
     ...
     *         The object of class HeaderConfiguration.
     *
     * @return
     *         A web socket.
     *
     ...
     *         handshake failed.
     */
    public WebSocket createSocket(String uri,HeaderConfiguration headerConfiguration) throws IOException
    {
        return createSocket(uri, getConnectionTimeout(),headerConfiguration);
    }



    public WebSocket createSocket(String uri, int timeout,HeaderConfiguration headerConfiguration) throws IOException
    {
        if (uri == null)
        {
        ...
        return createSocket(URI.create(uri), timeout,headerConfiguration);//,headerConfiguration
    }
    ...
    public WebSocket createSocket(String uri, int timeout) throws IOException
    {
        ...
        return createSocket(URI.create(uri), timeout,null);
    }
     ...
     * @since 1.10
     */
    public WebSocket createSocket(URI uri, int timeout,HeaderConfiguration headerConfiguration) throws IOException
    {
        if (uri == null)
        {
            throw new IllegalArgumentException("The given URI is null.");
        ...
        return createSocket(scheme, userInfo, host, port, path, query, timeout,headerConfiguration);
    }
    ...
    private WebSocket createSocket(
            String scheme, String userInfo, String host, int port,
            String path, String query, int timeout,HeaderConfiguration headerConfiguration) throws IOException
    {
        // True if 'scheme' is 'wss' or 'https'.
        boolean secure = isSecureConnectionRequired(scheme);
        ...
        // Create a WebSocket instance.
        return createWebSocket(secure, userInfo, host, port, path, query, connector,headerConfiguration);
    }
    ...
    private WebSocket createWebSocket(
            boolean secure, String userInfo, String host, int port,
            String path, String query, SocketConnector connector,HeaderConfiguration headerConfiguration)
    {
        // The value for "Host" HTTP header.
        if (0 <= port)
        {
        ...
        return new WebSocket(this, secure, userInfo, host, path, connector,headerConfiguration);
    }
