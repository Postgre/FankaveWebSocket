...
class HandshakeBuilder
{
    ...
    public void addProtocolList(Set<String> listOfProtocol)
    {
        mProtocols=listOfProtocol;
    }
    ...
    public void addExtensionList(List<WebSocketExtension> listOfExtensions )
    {
        mExtensions=listOfExtensions;
    }
    ...
    public void addHeaderList(List<String[]> listOfHeader)
    {
        mHeaders=listOfHeader;
    }
