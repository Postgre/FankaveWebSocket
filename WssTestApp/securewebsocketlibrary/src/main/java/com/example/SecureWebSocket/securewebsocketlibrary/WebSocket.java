...
import static com.example.SecureWebSocket.securewebsocketlibrary.WebSocketState.CONNECTING;
import static com.example.SecureWebSocket.securewebsocketlibrary.WebSocketState.CREATED;
import static com.example.SecureWebSocket.securewebsocketlibrary.WebSocketState.OPEN;
...
public class WebSocket
{
    ...
    WebSocket(WebSocketFactory factory, boolean secure, String userInfo,
              String host, String path, SocketConnector connector,HeaderConfiguration headerConfiguration)
    {
        mWebSocketFactory  = factory;
        mSocketConnector   = connector;
        mStateManager      = new StateManager();
        ...
        mPingSender        = new PingSender(this, new CounterPayloadGenerator());
        mPongSender        = new PongSender(this, new CounterPayloadGenerator());
        copyHeader(headerConfiguration,mHandshakeBuilder);
    }

    /**
     * This method copies data from headerconfiguration object to handshakebuilder.
     *@param handshakeBuilder
     * The object of class HandshakeBuilder.
    ...
    private void copyHeader(HeaderConfiguration headerConfiguration,HandshakeBuilder handshakeBuilder)
    {

        handshakeBuilder.setUserInfo(headerConfiguration.getmUserInfo());
        handshakeBuilder.setKey(headerConfiguration.getmKey());
        handshakeBuilder.addProtocolList(headerConfiguration.getmProtocols());
        handshakeBuilder.addExtensionList(headerConfiguration.getmExtensions());
        handshakeBuilder.addHeaderList(headerConfiguration.getmHeaders());
    }
